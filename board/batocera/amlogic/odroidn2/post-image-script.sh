...
# the aim of this script is to prepare output/batocera/boot depending on your target
# HOST_DIR = host dir
...
cp "${BOARD_DIR}/boot/extlinux.conf"               "${BATOCERA_BINARIES_DIR}/boot/boot/extlinux.conf"                 || exit 1
cp "${BOARD_DIR}/boot/boot.ini"                    "${BATOCERA_BINARIES_DIR}/boot/boot.ini"                           || exit 1
